...
function vowelCount(str) {
  ...
  let vowels = 'aeiou';
  return strArray.reduce(function (letter, nextValue) {
...
first subarray. If the result of the callback function at that specific value is false, the value should be 
