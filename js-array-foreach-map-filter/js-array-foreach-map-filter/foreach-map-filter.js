...
and the values as the number of times the vowel appears in the string. This function should be case insensitive so a 
...
function vowelCount(str) {
  ...
  Array.from(str).forEach(function (letter) {
    let droppedCase = letter.toLowerCase();
    if (vowels.indexOf(droppedCase) !== -1) {
      if (newObject[droppedCase]) {
        newObject[droppedCase]++;
      } else {
        newObject[droppedCase] = 1;
      }
    }
  });
  return newObject;
